<x-app-layout title="Utilisateur" activeTab="1">
    <div class="mx-7 flex flex-col items-start justify-center">
        <img class="absolute top-16 left-0 w-max h-max"
            src="https://source.unsplash.com/1500x500/?sport-{{ $user->name }}" />
        <div class="absolute top-36 left-7 mx-2 avatar bg-base-100 rounded-full">
            <div class="w-28 rounded-full ring ring-primary ring-offset-primary ring-offset-1 ring-">
                <img class="p-1 rounded-full" src="{{ $user->avatar }}" />
            </div>
        </div>
        <div class="flex flex-col w-full items-start mt-32 gap-7">
